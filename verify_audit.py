...
# P6
path = r"D:\OpenClawData\.openclaw\workspace\emotion-engine\massive_test_results.json"
...
# P7
py_dir = r"D:\OpenClawData\.openclaw\workspace\emotion-engine"
...
# P9
with open(r"D:\OpenClawData\.openclaw\workspace\emotion-engine\data\ae_stats.json", encoding="utf-8") as f:
    stats = json.load(f)
